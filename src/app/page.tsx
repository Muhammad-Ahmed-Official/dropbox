  ...
  return (
    <div className="bg-[#18181b]">
      <main className="flex-1">
              ...
              <div className="space-y-4 text-center lg:text-left">
                ...
                <div className="flex flex-wrap gap-4 pt-6 justify-center lg:justify-start">
                  {!isSignedIn ? (
                    <>
                      <Link href="/sign-up">
                        <Button size="lg" color="primary" className="bg-[#006fee] text-white" variant="solid">
                          Get Started Free
                        </Button>
                      </Link>
                      <Link href="/sign-in">
                        <Button size="lg" color="primary" className="bg-[#132946]" variant="flat">
                          Sign In
                        </Button>
                      </Link>
                    </>
        ...
        <section className="py-16 px-4 md:px-6 bg-[#18181b]">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="bg-linear-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white shadow-2xl">
              ...
              {!isSignedIn ? (
                <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
                  <Link href="/sign-up">
                    <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-10 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-200" endContent={<ArrowRight className="h-5 w-5 ml-2" />}>
                      Start Free Trial
                    </Button>
                  </Link>
                  <Link href="/sign-in">
                    <Button size="lg" variant="flat" className="border-2 border-white text-white hover:bg-white/10 font-semibold px-10 py-6 text-lg transition-all duration-200">
                      Learn More
                    </Button>
                  </Link>
                </div>
