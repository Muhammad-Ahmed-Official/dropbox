...
export default function Badge({children, color = "default", variant = "solid", size = "md", className, ...props} : BadgeProp & HTMLAttributes<HTMLSpanElement>) {
  ...
  return (
    <span className={cn( "inline-flex items-center justify-center font-medium", colorStyles[color][variant], sizeStyles[size], className)}{...props} >
      {children}
    </span>
  )
}
